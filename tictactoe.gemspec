...
=begin
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["source_code_uri"] = 'https://github.com/leila-alderman/tictactoe'
    spec.metadata["changelog_uri"] = 'https://github.com/leila-alderman/tictactoe/blob/master/README.md'
  else
